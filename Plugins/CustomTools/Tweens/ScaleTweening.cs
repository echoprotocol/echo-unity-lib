...
namespace CustomTools.Tweens {
    ...
    public sealed class ScaleTweening : TweeningParameter {

    	const Type SUPPORT_TYPES = Type.Scale | Type.X | Type.Y | Type.Z;
    	...
    	protected override Type BaseType => Type.Scale;
        ...
        public override Type[] UsedTypes {
            get { return new [] { Type.Scale, Type.X, Type.Y, Type.Z }; }
        }
